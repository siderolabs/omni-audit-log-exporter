...
all: unit-tests omni-audit-log-exporter image-omni-audit-log-exporter lint
...
.PHONY: $(ARTIFACTS)/omni-audit-log-exporter-linux-amd64
$(ARTIFACTS)/omni-audit-log-exporter-linux-amd64:
	@$(MAKE) local-omni-audit-log-exporter-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: omni-audit-log-exporter-linux-amd64
omni-audit-log-exporter-linux-amd64: $(ARTIFACTS)/omni-audit-log-exporter-linux-amd64  ## Builds executable for omni-audit-log-exporter-linux-amd64.

.PHONY: $(ARTIFACTS)/omni-audit-log-exporter-linux-arm64
$(ARTIFACTS)/omni-audit-log-exporter-linux-arm64:
	@$(MAKE) local-omni-audit-log-exporter-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: omni-audit-log-exporter-linux-arm64
omni-audit-log-exporter-linux-arm64: $(ARTIFACTS)/omni-audit-log-exporter-linux-arm64  ## Builds executable for omni-audit-log-exporter-linux-arm64.

.PHONY: omni-audit-log-exporter
omni-audit-log-exporter: omni-audit-log-exporter-linux-amd64 omni-audit-log-exporter-linux-arm64  ## Builds executables for omni-audit-log-exporter.
...
.PHONY: image-omni-audit-log-exporter
image-omni-audit-log-exporter:  ## Builds image for omni-audit-log-exporter.
	@$(MAKE) registry-$@ IMAGE_NAME="omni-audit-log-exporter"
